function calculate_particular_amount(element, type){
	...
	particular_rate = $(element).parent().parent().find('.particular_rate').val();
	if(type){
	...
	$(element).parent().parent().find('.particular_amount').html(particular_amount.toFixed(2));
...
function calculate_total_amount(){
	...
	$('.additional_particular_amount').each(function(){
	...
	$('.total_additional').html(total_additional_amount.toFixed(2));
...
function add_particular_group(){
	...
	dynamic_add_particulars.find('.additional_particular_amount').attr('name', 'additional_particular_amount[]');
...
function ded_particular_group(){
	...
	dynamic_ded_particulars.find('.deduction_particular_amount').attr('name', 'deduction_particular_amount[]');
