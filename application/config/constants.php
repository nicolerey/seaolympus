...
define('NAV_FILE_REQUEST', 'file_request');
define('NAV_VIEW_REQUESTS', 'view_requests');
define('NAV_DASHBOARD', 'dashboard');
define('NAV_DATA_ENTRY', 'data_entry');
...
define('SUBNAV_APPROVED_REQUESTS', 'approved_requests');
define('SUBNAV_DISCARDED_REQUESTS', 'discarded_requests');

define('MODE_CREATE', 'create');
define('MODE_EDIT', 'edit');

define('ROLE_STANDARD', 's');
define('ROLE_ADMIN', 'a');
define('ROLE_SUPERUSER', 'su');
